...
model = pickle.load(open(r"C:\Users\Plhv\VS_Code\Salary_prediction\linear_regression_model.pkl","rb"))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Vamshikrishna")
